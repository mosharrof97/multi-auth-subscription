...
<html lang="en">
  <head>
    ...
    <title>Md Mosharrof Hosain</title>
    <meta
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#role-user">
                  <i class="fas fa-layer-group"></i>
                  <p>Role & User</p>
                  <span class="caret"></span>
                </a>
                  ...
                  <ul class="nav nav-collapse">
                    ...
                    <li>
                      <a href="{{ route('admin.user.create') }}">
                        <span class="sub-item">User Create</span>
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="{{ route('admin.role.create') }}">
                        <span class="sub-item">Role Create</span>
                      </a>
                    </li>
                    ...
                    <li>
                      <a href="{{ route('admin.permission.create') }}">
                        <span class="sub-item">Permission Create</span>
                      </a>
                    </li>
              ...
              <li class="nav-item">
                <a data-bs-toggle="collapse" href="#Company_info">
                  <i class="fas fa-layer-group"></i>
                  <p>Company Info</p>
                  <span class="caret"></span>
                </a>
                <div class="collapse" id="Company_info">
                  <ul class="nav nav-collapse">
                    <li>
                      <a href="">
                        <span class="sub-item">Company Info</span>
                      </a>
                    </li>
                    <li>
                      <a href="">
                        <span class="sub-item">Company Info View</span>
                      </a>
                    </li>
                    ...
                    <div class="dropdown-user-scroll scrollbar-outer">
                      ...
                      <li>
                        ...
                        <form method="POST" class="dropdown-item" action="{{ route('logout') }}">
                          @csrf
                          {{-- <a class="dropdown-item ms-2" href="{{ route('company.logout') }}"
